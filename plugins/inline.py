...
buttons = [
    [
        ...
        InlineKeyboardButton('🧩 Destek', url='https://t.me/conquerofdeath0'),
    ]
    ]
def get_cmd(dur):
    if dur:
...
async def search(client, query):
    ...
    if query.query == "ETHO_ORUTHAN_PM_VANNU":
        answers.append(
            InlineQueryResultArticle(
                title="Deploy",
                input_message_content=InputTextMessageContent(f"{Config.REPLY_MESSAGE}\n\n<b>Bu botu grubunuzda kullanamazsınız, bunun için kendi botunuzu oluşturmalısınız. [SOURCE CODE](https://github.com/mutluemir08/VCPlayerBot) below.</b>", disable_web_page_preview=True),
